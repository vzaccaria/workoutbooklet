...
\begin{tikzpicture}[
   ...
   \node [anchor=west] at (-1,4) {\includegraphics[height=4cm]{./incline-dumbbell-fly.png}};
...
\begin{tikzpicture}[
   ...
   \node at (-0.5, 5) [anchor=east] {\tiny\textsf{notes}};
   \node at (-0.5, 5) [anchor=west, text width=10cm, inner sep=0pt, align=left] { \begin{minipage}{0.50\textwidth} \tiny weight is the weight of a single dumbbell \end{minipage} };


   \node at (-0.5, 6) [anchor=east] {\tiny\textsf{Sugg. Rmin}};
   \node at (-0.5, 6) [anchor=west, text width=10cm, inner sep=0pt, align=left] { \tiny 10 };

   \node at (-0.5, 5.5) [anchor=east] {\tiny\textsf{Sugg. Rmax}};
   \node at (-0.5, 5.5) [anchor=west, text width=10cm, inner sep=0pt, align=left] { \tiny 20 };
